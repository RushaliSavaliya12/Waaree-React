...
const ProductSubInverterOnGrid = () => {
    ...
    return(
        ...
        <InnerBannerSection bgSrc="assets/images/investor-bg.jpg" pageTitle="On Grid Inverter" bannerText="Waaree Energies Solar EPC solutions will provide a good return on investment by utilizing idle ground space or Land. Waaree provides customized EPC solution as per your need and energy consumption."/>
...
export default ProductSubInverterOnGrid;
