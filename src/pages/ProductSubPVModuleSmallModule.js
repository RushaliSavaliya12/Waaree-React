...
const ProductSubPVModuleSmallModule = () => {
    ...
    return(
        ...
        <InnerBannerSection bgSrc="assets/images/investor-bg.jpg" pageTitle="PV Module - Small Module" bannerText="Waaree Energies Solar EPC solutions will provide a good return on investment by utilizing idle ground space or Land. Waaree provides customized EPC solution as per your need and energy consumption."/>
...
export default ProductSubPVModuleSmallModule;
