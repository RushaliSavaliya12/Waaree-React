...
const BannerSlider = () => {
        ...
        const bannerSlideData = [
            {
              id:1,
              bgSrc:"assets/images/The-best-brand-of-the-year.jpg",
              slideTitle:"#1",
              slideMainTitle: "Best brand of the year 2020-21",
              buttonLink:"/about-waaree",
              titleBtnAnimation:"fadeInDown",
            },
            {
              id:2,
              bgSrc:"assets/images/2-GW-manufacturing-capacity.jpg",
              slideTitle:"#2GW",
              slideMainTitle:"Solar Panel Manufacturing Capacity ",
              buttonLink:"/manufacturing-plant",
              titleBtnAnimation:"fadeInLeft",
            },
            {
              id:3,
              bgSrc:"assets/images/540Wp-Generate-more-power.jpg",
              slideTitle:"540 Wp",
              slideMainTitle:"Generate more power",
              buttonLink:"#",
              titleBtnAnimation:"fadeInRight",
            },
            {
              id:4,
              bgSrc:"assets/images/600+-MW-EPC-Project.jpg",
              slideTitle:"600+ MW",
              slideMainTitle:"EPC Project",
              buttonLink:"/services",
