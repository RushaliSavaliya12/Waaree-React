            ...
            <div className="video-gallary-row four-col-row">
                <LightGallery
                    ...
                    {VideoGallaryFourColData.map((val) =>
                        <div className="gallary-item reveal-fade" key={val.id} data-src={val.gallaryImageSrc} data-sub-html={`<p> ${val.gallaryItemText} </p>`} data-src={val.gallaryVideoSrc} data-poster={val.gallaryImageSrc}>
